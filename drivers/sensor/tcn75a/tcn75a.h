...
#define TCN75A_CONFIG_ONEDOWN	(0x1 << 7)
#define TCN75A_CONFIG_9BIT_RES	(0x0 << 5)
#define TCN75A_CONFIG_10BIT_RES (0x1 << 5)
#define TCN75A_CONFIG_11BIT_RES (0x2 << 5)
#define TCN75A_CONFIG_12BIT_RES (0x3 << 5)
